...
// Chrome-free desk calculators — rendered natively inside terminal panels
// AND on the full /calc page (no iframe, no nested command bars).
export function CalcDesks() {
      ...
      {tab === "SIP" && (
        <div>
          ...
          <div className="cells" style={{ marginTop: 10 }}>
            <div className="cell"><div className="lbl">Invested</div><div className="val">₹{f2(sipIn)}</div></div>
            <div className="cell"><div className="lbl">Future value</div><div className="val pos">₹{f2(sipFV)}</div></div>
            <div className="cell"><div className="lbl">Gains</div><div className="val">{f2(sipFV - sipIn)}</div></div>
          </div>
      ...
      {tab === "CAGR" && (
        <div>
          ...
          <div className="cells" style={{ marginTop: 10 }}>
            ...
            <div className="cell"><div className="lbl">Double in</div><div className="val">{cagr > 0 ? `${(72 / (cagr * 100)).toFixed(1)}Y` : "—"}</div><div className="sub">rule of 72</div></div>
          </div>
        </div>
      )}
