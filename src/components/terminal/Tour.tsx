...
const STEPS: TourStep[] = [
  ...
  {
    title: "▮ 1/6 · COMMAND LINE — THE <GO> KEY",
  ...
  {
    title: "▮ 4/6 · FUNCTION KEYS F1–F12",
  ...
  {
    title: "▮ 5/6 · STATUS BAR — SAVE + DESKS",
  ...
  {
    title: "▮ 6/6 · YOUR STARTER DASHBOARD",
