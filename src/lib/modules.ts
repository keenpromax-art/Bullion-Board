...
export const MODULES: ModuleInfo[] = [
  ...
  m("37", "run_news_events_hub", "News & Events Hub", "News", "Yahoo + RSS + GoogleNews aggregation, dedup, sentiment, AI analyst."),
  ...
  m("45", "run_nbfc_news_scanner", "NBFC News Scanner", "News", "NBFC-focused RSS engine with sentiment + themes + AI chat."),
  m("46", "run_livemint_news", "Livemint Live Wire", "News", "Livemint/Mint feed wire with sentiment + AI scan."),
  ...
  m("50", "run_epub_reader", "EPUB Reader", "Reading", "Local EPUB library, chapters, bookmarks, progress, AI summariser/coach.", true),
