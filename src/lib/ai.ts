...
export const aiSystem = {
  ...
  preMarket: () =>
    sys(
      ...
      "PRE",
      "PRE-MARKET OPENING",
      "READ US FUTURES/SGX/VIX/BREADTH/SIGNAL VOTE/GAINERS-LOSERS. FORMAT: MARKET CALL (1 LINE — GAP UP/DOWN/FLAT + SIZE) + EVIDENCE (3 LINES: GLOBAL + VIX + BREADTH) + TOP 2 TRADE IDEAS (SYMBOL + DIRECTION + WHY) + 1 RISK. MAX 10 LINES."
    ),
  correlation: () =>
    sys(
      "A PORTFOLIO CONSTRUCTION ANALYST",
