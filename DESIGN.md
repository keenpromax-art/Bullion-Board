...
- Fit-to-panel: every panel body scale-fits (`FitBody`, zoom ≤ 1, recomputed on resize/data load) so the whole desk is always visible with zero scrolling. Maximize a panel for a larger view; minis stay 1:1.
